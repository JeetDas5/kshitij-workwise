    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-4 gap-6 mb-8">
          {[
            { label: 'New RFQs', value: stats.newRFQs, icon: ShoppingCart, color: 'blue' },
            { label: 'Quotes Received', value: stats.quotesReceived, icon: LineChart, color: 'yellow' },
            { label: 'Completed RFQs', value: stats.completedRFQs, icon: CheckSquare, color: 'teal' },
            { label: 'Closed RFQs', value: stats.closedRFQs, icon: XSquare, color: 'pink' }
          ].map((stat, index) => (
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <h2 className="text-xl font-semibold text-blue-900 mb-6">Chart Report from Jan 13 - Jan 19, 2025</h2>
        ...
        <Link to={'/rfq-creation'}  className="mt-14 bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors">
          Create New RFQ
        </Link>
      </div>
      <Footer/>
